...
import {useTypeahead} from '@astryxdesign/core/hooks';
...
// @astryxdesign/core/BaseProps isn't part of the package's public export
// map (the swizzle CLI's import rewriter doesn't catch internal-only
// type-only imports like this one) — replicated locally rather than
// reaching into the package's dist/ internals.
interface BaseProps<T extends HTMLElement = HTMLElement>
      ...
      <Button
        ...
        ref={el => {
          ...
          if (typeof consumerRef === 'function') {
            ...
            // ref callback forwarding a consumer ref object — the
            // `react-compiler/react-compiler` lint rule Astryx's own
            // monorepo suppresses this with isn't installed here.
