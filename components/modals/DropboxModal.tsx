      ...
      >
        ...
        <div className="relative bg-bg-chrome rounded-lg shadow-xl w-full max-w-md p-6">
          ...
          <div className="text-center">
            <Cloud size={48} className="mx-auto text-text-inverse mb-4" aria-hidden="true" />
            <h2 id="dropbox-connect-title" className="text-xl font-semibold text-text-inverse mb-2 text-balance">
              Connect to Dropbox
            </h2>
      ...
      <div className="relative bg-bg-chrome rounded-lg shadow-xl w-full max-w-lg max-h-[80vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border-subtle">
          <div className="flex items-center gap-2">
            ...
            <Cloud size={24} className="text-text-inverse" aria-hidden="true" />
            <h2 id="dropbox-modal-title" className="text-lg font-semibold text-text-inverse text-balance">
        ...
        {/* Current path */}
        <div className="px-4 py-2 text-sm text-text-secondary border-b border-border-subtle">
          {dropbox.currentPath || "/"}
        </div>
        ...
        <div className="flex-1 overflow-auto p-4">
          {mode === "save" && (
            <div className="mb-4 p-3 bg-bg-surface-hover rounded">
              <label htmlFor="dropbox-filename" className="block text-sm text-text-secondary mb-1">
                File name
              </label>
              <input
                id="dropbox-filename"
