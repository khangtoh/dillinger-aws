  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="text-content-muted text-lg mb-4 max-w-2xl">
        ...
        <code className="bg-surface-subtle text-icon-muted rounded-control px-1.5 py-0.5 text-base font-mono">
          .md
        </code>{" "}
      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="text-content-muted mb-4">
            ...
            <code className="bg-surface-subtle text-icon-muted rounded-control px-1.5 py-0.5 text-sm font-mono">
              .md
            </code>{" "}
        ...
        <div className="space-y-6">
          {FAQ.map((item) => (
            <div key={item.question}>
              ...
              <p className="text-content-muted">{item.answer}</p>
            </div>
          ))}
        </div>
      </div>
