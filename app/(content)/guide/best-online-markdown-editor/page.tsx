...
export default function BestOnlineMarkdownEditorPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
            ...
            <tbody>
              {TLDR.map((row) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-content-muted">{row.bestFor}</td>
                  <td className="py-3 px-4 text-content-muted">{row.free}</td>
                  <td className="py-3 pl-4 text-content-muted">{row.cloud}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="space-y-14 mb-16">
        {EDITORS.map((editor) => (
          ...
          >
            ...
            <p className="text-content-muted mb-6">{editor.description}</p>
        ...
        <div className="space-y-8">
          {FAQ.map((item) => (
            <div key={item.q}>
              ...
              <p className="text-content-muted">{item.a}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <p className="mt-16 text-sm text-content-muted">Last updated: May 2026</p>
